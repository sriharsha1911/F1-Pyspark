...
# MAGIC %md
# MAGIC ## writing dataframe as delta table (prev parquet )

# COMMAND ----------

container_name='processed'
#circuit_df.write.parquet(f"{processed_folder_path}/circuits",mode='overwrite')
#circuit_df.write.mode('overwrite').format("delta").save("abfss://demo@f1sa.dfs.core.windows.net/circuits_delta")
circuit_df.write.mode('overwrite').format("delta").saveAsTable("f1_processed.circuits")

# COMMAND ----------

# MAGIC %fs
# MAGIC ls 'dbfs:/user/hive/warehouse/f1_processed.db/circuits'
